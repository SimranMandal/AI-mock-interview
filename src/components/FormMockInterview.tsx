...
export const FormMockInterview = ({initialData} : FormMockInterviewProps) => {
  ...
  // useEffect(() => {
  //   if (initialData) {
  //     // Check if the form values are already set to avoid unnecessary resets
  //     const currentValues = form.getValues();
  //     if (
  //       currentValues.position !== initialData.position ||
  //       currentValues.description !== initialData.description ||
  //       currentValues.experience !== initialData.experience ||
  //       currentValues.techStack !== initialData.techStack
  //     ) {
  //       form.reset({
  //         position: initialData.position,
  //         description: initialData.description,
              ...
              <FormItem className="w-full space-y-4">
                ...
                <FormControl>
                  ...
                  {...field}
                    disabled={loading}
                    className="h-12"
                    placeholder="eg:- React, TypeScript... (Separate the name of the skills using commas)"
                    value={field.value || ""}

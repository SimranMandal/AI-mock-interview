...
export const RecordAnswer = ({question, isWebCam, setIsWebCam} : RecordAnswerProps) => {
    ...
    const saveUserAnswer = async () => {
        ...
        try {
            ...
            //if the user already answered the quesstion don't save it again
            if (!querySnap.empty) {
            ...
            toast("Error", {
                description: "An errro occurred while generating feedback.",
            });
            console.log(error);
    ...
    useEffect (() => {
        const combineTranscriipts = results
        .filter((result) : result is ResultType => typeof result !== "string")
        .map((result) => result.transcript)
        .join(" ");

        setUserAnswer(combineTranscriipts);
    }, [results]);
